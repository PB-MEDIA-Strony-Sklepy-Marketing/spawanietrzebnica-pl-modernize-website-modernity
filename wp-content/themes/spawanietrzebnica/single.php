      ...
      <div class="blog-list blog-content">
        <div class="blog-post" id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
          ...
          <div class="post-content-text">
            ...
            <h2 class="title"><a href="<?php the_permalink(); ?>">
              <?php if (strlen($title) == 0) esc_html_e('Untitled Posts', 'welderpro'); else echo esc_html($title); ?>
              </a></h2>
            ...
            <?php
                        wp_link_pages( array(
                            'before'      => '<div class="page-links"><span class="page-links-title">' . esc_html__( 'Pages:', 'welderpro' ) . '</span>',
                            'after'       => '</div>',
                            'link_before' => '<span>',
                            'link_after'  => '</span>',
                            'pagelink'    => '<span class="screen-reader-text">' . esc_html__( 'Page', 'welderpro' ) . ' </span>%',
        ...
        <?php 
                ...
                the_post_navigation( array(
                  'next_text' => '<span class="meta-nav btn read-more" aria-hidden="true">' . esc_html__( 'Next >>', 'welderpro' ) . '</span> ' .
                    '<span class="screen-reader-text">' . esc_html__( 'Next post:', 'welderpro' ) . '</span> ' ,
                  'prev_text' => '<span class="meta-nav btn read-more" aria-hidden="true">' . esc_html__( '<< Previous', 'welderpro' ) . '</span> ' .
                    '<span class="screen-reader-text">' . esc_html__( 'Previous post:', 'welderpro' ) . '</span> ' ,
                ) ); 
              ?>
        <?php 
