 ...
 *
 * @package WP Speed Of Light Addon
 * @author  Joomunited
 * @version 1.0
 */
...
class JUCheckRequirements
{
    ...
    public static function printError()
    {
        ...
        <div class="notice notice-error is-dismissible">
            <?php echo self::$error; // phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped -- Notify text?>
        </div>
        <?php
    }
    ...
    public static function printWarning()
    {
        ...
        <div class="notice notice-warning is-dismissible">
            <?php echo self::$warning; // phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped -- Notify text?>
        </div>
        <?php
    }
    ...
    public static function printInfo()
    {
        ...
        <div class="notice notice-info is-dismissible">
            <?php echo self::$info; // phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped -- Notify text?>
        </div>
        <?php
    }
